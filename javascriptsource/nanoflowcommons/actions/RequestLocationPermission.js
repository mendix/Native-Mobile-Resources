...
async function RequestLocationPermission() {
  ...
  const hasPermissionIOS = async () => {
    const openSetting = () => {
      reactNativeModule === null || reactNativeModule === void 0
        ? void 0
  ...
  const hasPermissionAndroid = async () => {
    ...
    if (
      typeof ((_a =
        reactNativeModule === null || reactNativeModule === void 0
          ? void 0
          : reactNativeModule.Platform) === null || _a === void 0
        ? void 0
        : _a.Version) === "number" &&
      ((_b =
        reactNativeModule === null || reactNativeModule === void 0
          ? void 0
          : reactNativeModule.Platform) === null || _b === void 0
        ? void 0
        : _b.Version) < 23
    ) {
      return true;
    ...
    return reactNativeModule === null || reactNativeModule === void 0
      ? void 0
      : reactNativeModule.PermissionsAndroid.check(
          ...
          return hasPermission
            ...
            : (_a =
                reactNativeModule === null || reactNativeModule === void 0
                  ? void 0
                  : reactNativeModule.PermissionsAndroid) === null ||
              _a === void 0
            ? void 0
            : _a.request(androidLocationPermission).then((status) => {
                if (
                  status ===
                  (reactNativeModule === null || reactNativeModule === void 0
                    ? void 0
                    : reactNativeModule.PermissionsAndroid.RESULTS.GRANTED)
                ) {
                  return true;
                }
                if (
                  ...
                  (reactNativeModule === null || reactNativeModule === void 0
                    ? void 0
                    : reactNativeModule.PermissionsAndroid.RESULTS.DENIED)
                ) {
                  ...
                  (reactNativeModule === null || reactNativeModule === void 0
                    ? void 0
                    : reactNativeModule.PermissionsAndroid.RESULTS
                        .NEVER_ASK_AGAIN)
                ) {
                  reactNativeModule.ToastAndroid.show(
  ...
  const hasLocationPermission = async () => {
    if (
      (reactNativeModule === null || reactNativeModule === void 0
        ? void 0
        : reactNativeModule.Platform.OS) === "ios"
    ) {
    ...
    if (
      ...
      return hasPermission !== null && hasPermission !== void 0
        ? hasPermission
        : false;
    }
  ...
  const hasLocationPermissionForOldLibrary = async () => {
    if (
      ...
      const locationPermission =
        reactNativeModule.PermissionsAndroid.PERMISSIONS.ACCESS_FINE_LOCATION;
      return reactNativeModule.PermissionsAndroid.check(
        locationPermission
      ).then((hasPermission) =>
        hasPermission
          ? true
          : reactNativeModule === null || reactNativeModule === void 0
          ? void 0
          : reactNativeModule.PermissionsAndroid.request(
              locationPermission
            ).then(
              (status) =>
                status ===
  ...
  if (navigator && navigator.product === "ReactNative") {
    ...
    if (!reactNativeModule) {
      return Promise.reject(
        new Error("React Native module could not be found")
      );
    }
    if (reactNativeModule.NativeModules.RNFusedLocation) {
      geolocationModule = (await import("react-native-geolocation-service"))
        .default;
      return hasLocationPermission();
    } else if (reactNativeModule.NativeModules.RNCGeolocation) {
      geolocationModule = Geolocation;
      return (_a = await hasLocationPermissionForOldLibrary()) !== null &&
        _a !== void 0
        ? _a
        : false;
    } else {
    ...
    return Promise.reject(
      new Error(
        "No permission request for location is required for web/hybrid platform"
      )
    );
  } else {
    return Promise.reject(new Error("Geolocation module could not be found"));
