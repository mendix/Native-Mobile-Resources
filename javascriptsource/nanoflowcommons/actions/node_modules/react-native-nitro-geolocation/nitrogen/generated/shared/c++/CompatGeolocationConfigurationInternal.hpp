///
/// CompatGeolocationConfigurationInternal.hpp
...
namespace margelo::nitro::nitrogeolocation {
  ...
  /**
   * A struct which can be represented as a JavaScript object (CompatGeolocationConfigurationInternal).
   */
  struct CompatGeolocationConfigurationInternal final {
  public:
  ...
  public:
    CompatGeolocationConfigurationInternal() = default;
  ...
  public:
    friend bool operator==(const CompatGeolocationConfigurationInternal& lhs, const CompatGeolocationConfigurationInternal& rhs) = default;
  };
...
namespace margelo::nitro {
  ...
  // C++ CompatGeolocationConfigurationInternal <> JS CompatGeolocationConfigurationInternal (object)
  template <>
  struct JSIConverter<margelo::nitro::nitrogeolocation::CompatGeolocationConfigurationInternal> final {
    static inline margelo::nitro::nitrogeolocation::CompatGeolocationConfigurationInternal fromJSI(jsi::Runtime& runtime, const jsi::Value& arg) {
      jsi::Object obj = arg.asObject(runtime);
      return margelo::nitro::nitrogeolocation::CompatGeolocationConfigurationInternal(
    ...
    static inline jsi::Value toJSI(jsi::Runtime& runtime, const margelo::nitro::nitrogeolocation::CompatGeolocationConfigurationInternal& arg) {
