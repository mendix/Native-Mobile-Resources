...
export declare const canScheduleExactAlarms: jest.Mock<Promise<boolean>, [], any>;
export declare const canUseFullScreenIntent: jest.Mock<Promise<boolean>, [], any>;
export declare const check: jest.Mock<Promise<"granted">, [], any>;
export declare const checkLocationAccuracy: jest.Mock<Promise<string>, [], any>;
export declare const openPhotoPicker: jest.Mock<Promise<void>, [], any>;
export declare const openSettings: jest.Mock<Promise<void>, [], any>;
export declare const request: jest.Mock<Promise<"granted">, [], any>;
export declare const requestLocationAccuracy: jest.Mock<Promise<string>, [], any>;
export declare const checkNotifications: Contract['checkNotifications'];
export declare const requestNotifications: Contract['requestNotifications'];
export declare const checkMultiple: Contract['checkMultiple'];
export declare const requestMultiple: Contract['requestMultiple'];
declare const _default: {
    ...
    canScheduleExactAlarms: jest.Mock<Promise<boolean>, [], any>;
    canUseFullScreenIntent: jest.Mock<Promise<boolean>, [], any>;
    check: jest.Mock<Promise<"granted">, [], any>;
    checkLocationAccuracy: jest.Mock<Promise<string>, [], any>;
    checkMultiple: <P extends import("..").Permission[]>(permissions: P) => Promise<Record<P[number], PermissionStatus>>;
    checkNotifications: () => Promise<import("..").NotificationsResponse>;
    openPhotoPicker: jest.Mock<Promise<void>, [], any>;
    openSettings: jest.Mock<Promise<void>, [], any>;
    request: jest.Mock<Promise<"granted">, [], any>;
    requestLocationAccuracy: jest.Mock<Promise<string>, [], any>;
    requestMultiple: <P extends import("..").Permission[]>(permissions: P) => Promise<Record<P[number], PermissionStatus>>;
    requestNotifications: (options?: import("..").NotificationOption[], rationale?: import("..").Rationale) => Promise<import("..").NotificationsResponse>;
};
