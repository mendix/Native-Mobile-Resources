 ...
 */
export function parseFcmPayload(data) {
    ...
    if (!Number.isNaN(versionNum) && versionNum > 1) {
        console.warn(`${PREFIX} notifee_options version ${versionNum} is newer than supported version 1. Display may be incomplete.`);
    }
    return parsed;
}
//# sourceMappingURL=parseFcmPayload.js.map