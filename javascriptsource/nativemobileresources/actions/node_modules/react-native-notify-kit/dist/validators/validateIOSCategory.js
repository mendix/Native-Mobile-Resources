 ...
 */
import { IOSIntentIdentifier, } from '../types/NotificationIOS';
...
export default function validateIOSCategory(category) {
    ...
    if (objectHasProperty(category, 'intentIdentifiers')) {
        ...
        const identifiers = Object.values(IOSIntentIdentifier).filter((identifier) => typeof identifier === 'number');
