...
export function validateAndroidBigPictureStyle(style) {
    if ((!isString(style.picture) && !isNumber(style.picture) && !isObject(style.picture)) ||
 ...
 */
export function validateAndroidInboxStyle(style) {
 ...
 */
export function validateAndroidPerson(person) {
...
export function validateAndroidMessagingStyleMessage(message) {
 ...
 */
export function validateAndroidMessagingStyle(style) {
