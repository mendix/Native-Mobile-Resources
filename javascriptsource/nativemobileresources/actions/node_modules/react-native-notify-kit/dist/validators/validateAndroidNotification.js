...
import { objectHasProperty, isArray, isArrayOfStrings, isBoolean, isNumber, isObject, isString, isUndefined, isIOS, isValidEnum, getNumericEnumValues, } from '../utils';
import { AndroidImportance } from '../types/NotificationAndroid';
import { AndroidBadgeIconType, AndroidCategory, AndroidDefaults, AndroidForegroundServiceBehavior, AndroidForegroundServiceType, AndroidFlags, AndroidGroupAlertBehavior, AndroidStyle, AndroidVisibility, } from '../types/NotificationAndroid';
import { isValidColor, isValidLightPattern, isValidTimestamp, isValidVibratePattern, } from './validate';
import { validateAndroidBigPictureStyle, validateAndroidBigTextStyle, validateAndroidInboxStyle, validateAndroidMessagingStyle, } from './validateAndroidStyle';
...
export default function validateAndroidNotification(android) {
    ...
    if (objectHasProperty(android, 'foregroundServiceBehavior') &&
        ...
        if (!isValidEnum(android.foregroundServiceBehavior, AndroidForegroundServiceBehavior)) {
            throw new Error("'notification.android.foregroundServiceBehavior' expected a valid AndroidForegroundServiceBehavior.");
        }
     ...
     * groupAlertBehavior
     */
    if (objectHasProperty(android, 'groupAlertBehavior') &&
     ...
     */
    if (objectHasProperty(android, 'foregroundServiceTypes') &&
     ...
     */
    if (objectHasProperty(android, 'pressAction') &&
