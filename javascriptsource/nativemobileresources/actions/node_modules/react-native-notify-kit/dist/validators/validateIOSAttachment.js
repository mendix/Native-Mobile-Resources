...
import { generateId, isBoolean, isNumber, isObject, isString, isUndefined, objectHasProperty, } from '../utils';
export default function validateIOSAttachment(attachment) {
    if (!isObject(attachment)) {
        throw new Error("'attachment' expected an object value.");
    }
    if ((!isString(attachment.url) && !isNumber(attachment.url) && !isObject(attachment.url)) ||
    ...
    if (objectHasProperty(attachment, 'thumbnailClippingRect') &&
    ...
    if (objectHasProperty(attachment, 'thumbnailHidden') &&
 ...
 */
export function validateThumbnailClippingRect(thumbnailClippingRect) {
